...
class NylasAuthService:
    ...
    def generate_auth_url(self, config: AuthUrlConfig) -> str:
        ...
        return self._nylas.auth.url_for_oauth2(auth_config)  # type: ignore[reportArgumentType]
    ...
    def exchange_code_for_token(self, request: CodeExchangeInput) -> GrantAuthResult:
        ...
        response = self._nylas.auth.exchange_code_for_token(exchange_request)  # type: ignore[reportArgumentType]

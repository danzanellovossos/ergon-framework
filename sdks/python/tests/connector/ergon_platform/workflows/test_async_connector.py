...
from ergon.connector.ergon_platform.workflows.async_connector import AsyncErgonPlatformConnector
...
def _make_connector(consumer_config=None, producer_config=None, sdk_client=None) -> AsyncErgonPlatformConnector:
    ...
    with patch(
        "ergon.connector.ergon_platform.workflows.async_connector.create_ergon_client",

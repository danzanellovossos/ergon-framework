...
The logging subsystem wraps the SDK's standard logging infrastructure and enhances it with OTel integration.
...
Telemetry is configured via declarative configuration objects passed to the task configuration (`TaskConfig`). These objects map directly to the underlying configuration structures:
